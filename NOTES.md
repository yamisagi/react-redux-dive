...
### <span style="color:c1121f"> _**Core concept of Redux is**_</span>
...
// We can use 'useDispatch' hook to dispatch an action.

dispatch(action); // We can use like this. Or we can use like below.
dispatch({ type: 'ADD', payload: 10 });
dispatch({ type: 'SUBTRACT', payload: 5 });
```
